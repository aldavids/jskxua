...
(function () {
  Array.from(document.querySelectorAll('.spinitron-js-widget')).forEach(function (widget, index) {
    ...
    // Removed 'meta' from the query parameters
    var query = ['station', 'num', 'count', 'time', 'nolinks', 'sharing', 'player', 'cover', 'merch', 'layout', 'image', 'description'].reduce(function (q, param) {
